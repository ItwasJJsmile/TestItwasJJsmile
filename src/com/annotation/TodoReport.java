...
public class TodoReport {
    ...
    public static void main(String[] args) {
        getTodoReportForBusinessLogic(BusinessLogic.class);
    }

    /**
     * This method iterates through all messages of BusinessLogic class and 
     * fetches annotations defined on each of them.
     * After that it displays the information from annotation accordingly.
     */
    private static void getTodoReportForBusinessLogic(Object o) {
